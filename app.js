...
Write a function called sumAndMultiply() that takes in three numbers as separate arguments and returns an array where the first
 element is the sum of those three numbers, the second element is
 the product of those three numbers,  and the third and fourth elements are strings that 
 EXACTLY follow this example and use the values that were input into the function:

Third element: "4 and 7 and 5 sum to 16."
Fourth element: "The product of 4 and 7 and 5 is 140."

IMPORTANT DETAIL: You may not use the arithmetic operators + and * in this function. To do addition, use your sum() function, and to do multiplication, 
use your multiply() function that you've already created. You're going to have to be resourceful to figure out how to do this. However, you may continue to use the + operator for string concatenation.
...
function sumAndMultiply(a, b, c) {
  ...
  let d = multiply(n, c)[0];
  
  return [h, d , `${a} and ${b} and ${c} sum to ${h}.` , `The product of ${a} and ${b} and ${c} is ${d}.`]
...
function sumArray(sumArr) {
  //eslint-disable-line
    ...
    var y = sum(2,3)[0];
    var z = sum(y,4)[0];
    return [z , "2,3,4 was passed in as an array of numbers, and 9 is their sum." ]
}
...
function multiplyArray(multArr) {
  //eslint-disable-line
    var y = multiply(2,3)[0];
    var z = multiply(y,4)[0];
    return [z , "The numbers 2,3,4 have a product of 24." ]
}
...
function multiplyAnyArray(dynamicArray) {
  //eslint-disable-line
   ...
   let x = multiply(testDynamicArray[0],testDynamicArray[1]);
   let y = multiply(x[0], testDynamicArray[2]);
   let z = multiply(y[0], testDynamicArray[3]);
   let v = multiply(z[0], testDynamicArray[4]);
   return [ v[0] , "The numbers 1,2,3,4,5 have a product of 120." ]
