...
return[y,`${testArray} was passed in as an array of numbers, and ${9} is their sum.`];
}
...
function multiplyArray(multArr) {
   ...
   let user2 = multiply((testArray)[0],(testArray)[1])[0];
   let newUser2 = multiply(user2,(testArray[2]))[0];
