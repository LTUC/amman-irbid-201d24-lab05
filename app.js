...
//   //eslint-disable-line
//   return [sum1(4, 7, 5), multiply1(4, 7, 5), '4 and 7 and 5 sum to 16.', 'The product of 4 and 7 and 5 is 140.'];
...
let userInput = Number(prompt('what is the level of stars you want ?'));


for (let attempts = 1; attempts <= 1; attempts++) {
