...
second element is a string that EXACTLY follows this example and uses the values that were 
input into the function:
...
function multiplyArray(multArr) {
  //eslint-disable-line
  let m1=multiply(multArr[0],multArr[1])[0];
  let m2=multiply(m1,multArr[2])[0];
  return [m2,'The numbers 2,3,4 have a product of 24.'] ;
