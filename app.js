...
function multiplyArray(multArr) {
  let multi3=multiply(2,3)[0];
  let multi4=multiply(multi3,4)[0];
  return [multi4,'The numbers 2,3,4 have a product of 24.'];
  //eslint-disable-line
...
for (let i=0 ; i<dynamicArray .length; i++){
  multi5=multiply(multi5,dynamicArray[i])[0];


}  
return[multi5,'The numbers 1,2,3,4,5 have a product of 120.'];
  //eslint-disable-line
}
